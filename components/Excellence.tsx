...
export const Excellence = () => {
  ...
  return (
    <section
      ...
      className="relative min-h-screen border-b-3 border-white bg-[#EED7C8]/45 w-full overflow-visible bg-cover bg-center bg-no-repeat max-lg:border-white py-32 lg:py-10 px-8 sm:px-16 lg:px-20"
    >
